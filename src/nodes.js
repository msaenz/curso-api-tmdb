...
// Elements
const optionLanguages = document.querySelector('#optionLanguages')
...
const footerCaption = document.querySelector('footer')
const selectCaption = document.querySelector('.header-lang')
